...
project_ctrl_v6_design.md および同ディレクトリの README.md 参照。
このファイルはリポジトリ shoki-hihara/KurtosisController の v6_diagnostics/
サブディレクトリで管理される(同リポジトリの他axisサブディレクトリには、
テキストデータ実験 train_text_lstm.py 等も同様に配置される想定)。)
